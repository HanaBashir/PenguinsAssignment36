...
My partner's code included lots of elements to help me understand their code. Firstly, they separate their code into code chunks rather than writing one huge chunk of code. This meant that I could run each chunk separately and see the output from that chunk before moving on to the next. This really helped to understand which part of the code is doing what and what it is producing. Secondly, my partner used hashtags to provide comments explicitly explaining what every line of code does. They didn't just comment what a chunk was doing, they commented each line within the chunk to provide a really detailed explanation. My partner also provided a read.me file in their repository which helped to gain an initial understanding of what the project was about and what was in the important files. In most of their code they also used tabs and indentations which made the code more readable. There was just one part where for some reason this didn't format in the same way (explained below). Finally, my partner also explained in plain text what the chunk was about to do by saying 'here I...' and then having the chunk below this. They also labelled all their chunks which meant I knew the main idea of what each was doing. Overall, I think they made their code so it could be well understood.


-   *Did it run? Did you need to fix anything?*

It ran the first time with no issues and also rendered. 

-   *What suggestions would you make for improving their code to make it more understandable or reproducible, and why?*

There was one section at the start of the code where the code could have been formatted to be more readable. When my partner coded the density plot for body mass by species there weren't indentations or tabs so it look like one big paragraph. Having said this, they did still comment out every single line of the code so it was still completely understandable (just not as visually appealing). I would suggest altering the format of the code though, for example when using ggplot() have each function directly below this with the + sign at the end of each line. In the code directly below for the density plot of flipper length by species my partner formatted it out nicely so it was more readable however there were less comments describing what each individual line did. To improve the code I suggest making sure that includes both good formatting (indentations and tabs) and commenting out each line together. If my partner had done this for both plots it would have provided more consistency when reading the code as well. having said this, I actually don't know if this is possible as maybe the format is like these because the commented out hashtags  run over to the next line. 

-   *If you needed to alter your partner's figure using their code, do you think that would be easy or difficult, and why?*

I think it it would be easy to alter the figures because the code to plot
- 
...
My partner said that overall my code was highly organised however there were some areas were just a few extra annotations could have been useful. For example at the start of the script in the chunk with library() in it I didn't comment out explicitly that this was opening the packages. I agree I should have done this as my code is supposed to be accessible to everyone and even though I know what library() means, others may not. They also said abbreviations could be confusing as at one point I said 'home' in a comment rather than homoscedasticity. I completely agree next time I shouldn't abbreviate. Additionally my partner highlighted apiece of redundant code:  colnames(penguins_raw) which was repeated. I agree this is distracting and wasn't absolutely necessary. Finally my partner said that the names of my plots could have been clearer. I named them gentoo_explorplot and gentoo_resultsplot. I think gentoo_exploratoryplot would have been better, but my partner said specifying the results plot as gentoo_scatterplot. I don't agree with this simply because my exploratory figure was also a scatterplot so it will create confusion. 
